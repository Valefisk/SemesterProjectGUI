...
import com.dk.sdu.domain.commands.Commands;
...
public class CommandLineClient {
    ...
    public void play() {
        ...
        System.out.println();
        System.out.println("Thank you for playing WorldOfChop!");
        //System.out.printf("\n"+"Your final highscore & sustainability rating is: "+"%.2f");
    }

    private void printWelcome() {
        System.out.println();
        System.out.println("Welcome to WorldOfChop");
        System.out.println("Your objective is to get as much money by chopping wood and restoring forests in a sustainable way in 30 moves!");
        System.out.println("Money is earned by cutting woods, and spent on planting new saplings that will grow into new trees.");
        System.out.println("You final score is calculated on how sustainably you've managed the forests.");
